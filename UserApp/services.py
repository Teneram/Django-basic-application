...
class UsersService:
    @staticmethod
    def update_user(
        request: HttpRequest, user: Users, data: dict, avatar: Optional[UploadedFile]
    ) -> HttpResponse | None:
    ...
    @staticmethod
    def get_auth_user_by_id(user_id: int) -> Optional[Users]:
    ...
    @staticmethod
    def get_user_by_id(user_id: int) -> Union[Users, JsonResponse]:
        return UsersRepository.get_user(user_id=user_id)

    @staticmethod
    def get_user_by_username(username: str) -> Union[Users, JsonResponse]:
        return UsersRepository.get_user(username=username)

    @staticmethod
    def get_all_users(search_query) -> QuerySet[Users]:
    ...
    @staticmethod
    def reset_password_massage(request: HttpRequest, user: Users) -> str:
        message = render_to_string(
